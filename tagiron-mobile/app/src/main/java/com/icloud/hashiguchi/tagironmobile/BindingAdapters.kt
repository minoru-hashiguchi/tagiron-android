...
object BindingAdapters {
    ...
    //    @BindingAdapter(value = ["textViewBackground"])
//    fun setTextViewHintColor(textView: TextView, color: Int?) {
//        textView.setBackgroundColor(color ?: R.color.tile_color_undefined)
//    }
    @BindingAdapter(value = ["textViewBackground"])
    @JvmStatic
    fun setTextViewBackGroundColor(textView: TextView, color: Int) {
